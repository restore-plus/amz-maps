...
| Spectral Bands       | `BLUE`, `GREEN`, `RED`, `NIR08`, `SWIR16`, `SWIR22`|
| Spectral Indices     | `NDVI`, `EVI`, `MNDWI`, `NBR` |
| Note | Original data collected using HLS (Harmonized Landsat Sentinel) images. Geographical locations were re-used by LUC-Brasil to collect time series of Landsat images | 
| Source            | Anielli Souza, Miguel Monteiro, Isabel Escada  (INPE)|
