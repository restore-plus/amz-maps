...
| Spatial resolution | Landsat (2004-2016) and Sentinel-2 (2018-2022)|
| Key classes (2022-2024 versions) | Silviculture, Perennial, Semiperennial and Annual Agriculture, Herbaceous Pasture, Shrubby Pasture, Secondary Vegetation, Mining, Urban area, Water |
...
The Amazon biome has areas of Cerrado vegetation. Such areas are described as "Non-forest vegetation" (NF) and comprise about 6.6% (280,000 km²) of the biome. NF occurs as open-like formations such as savannas and grasslands; seasonally flooded areas with sandy soils and sparse trees; ecotones; isolated forest patches with deciduous, semi-deciduous, and even broadleaf characteristics; and natural areas of bare lands. The PRODES system uses a mask covering these areas since it is only targeted to measure loss of forest cover. This mask is used by the LUC-Brasil team to distinguish between forest and non-forest areas. 
...
| Note | Original data collected using Landsat-TM images. Geographical locations were re-used by LUC-Brasil to collect time series of Landsat images | 
