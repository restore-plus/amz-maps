...
: Technical specifications of the GLAD Landsat data {#tbl-glad}
...
: Technical specifications of the BDC Landsat data {#tbl-bdc}
...
: Technical specifications of the PRODES deforestation data {#tbl-prodes}
...
: Technical specifications of the Terraclass land cover surveys {#tbl-terraclass}
...
: Technical specifications of the water masks {#tbl-water-mask}
...
: Technical specifications of the non-forest vegetation mask {#tbl-nonforest-mask}
...
These data sets are openly available in the Github repository [lulcbrasil-samples](https://github.com/restore-plus/lulcbrasil-samples). 
...
: Sample dataset: land use and land cover in Baixo Tocantins (2021) {#tbl-samples-tocantins}
...
: Sample dataset: land cover in the Amazon Rainforest {#tbl-samples-rainforest}
...
: Sample dataset: land use and land cover in Rondonia (2022) {#tbl-samples-rondonia}
...
: Sample dataset: land use and land cover in the Legal Amazon (2019-2020) {#tbl-samples-amazon-2019}

### Land Use and Land Cover in Legal Amazon (2021-2022)

The metadata of this dataset is presented in @tbl-samples-amazon-2021.
...
: Sample dataset: land use and land cover in the Legal Amazon (2021-2022) {#tbl-samples-amazon-2021}
