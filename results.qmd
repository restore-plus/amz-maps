...
#| out-width: 90%
#| fig-align: "center"
#| fig-cap: Secondary vegetation area (Mha) in Amazonia (2000-2022)
knitr::include_graphics("./images/secondary_vegetation.png") 
```

### Accuracy assessment {-}

Accuracy assessment was performed by comparing the Restore+ maps with the TerraClass reference data. The user's and producer's accuracies for the years 2008, 2010, 2012, 2014, 2016, 2018, 2020, and 2022 are presented in @tbl-accuracy-producer and @tbl-accuracy-user.

::: {#tbl-accuracy-producer}
...
Producer's accuracy (%) by class and year
:::
...
User's accuracy (%) by class and year
:::
