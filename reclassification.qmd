...
This rule uses a three-year period to adjust misclassification scenarios and unlikely changes between cropland and pasture. For example, pixels labelled `cropland - pasture - cropland` are reclassified as `cropland - cropland - cropland`. 
